...
__CONFIG__ = {'webhook': None, 'ping': True, 'pingtype': 'Everyone', 'error': True, 'startup': False, 'defender': False, 'systeminfo': True, 'backupcodes': True, 'browser': True, 'roblox': True, 'obfuscation': False, 'injection': False, 'minecraft': True, 'wifi': True, 'killprotector': True, 'antidebug_vm': False, 'discord': False, 'anti_spam': True, 'self_destruct': False}
